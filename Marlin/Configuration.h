...
#define DELTA
  ...
  #define DELTA_DIAGONAL_ROD 289.03 // mm

  // Horizontal offset from middle of printer to smooth rod center.
  #define DELTA_SMOOTH_ROD_OFFSET 180.34 // mm
 ...
 * Override with M92
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80, 80, 80, 389.20}  // default steps per unit for Kossel (GT2, 20 tooth)
...
#define Z_PROBE_ALLEN_KEY
  ...
  #define Z_PROBE_ALLEN_KEY_DEPLOY_1_X  65.0
  #define Z_PROBE_ALLEN_KEY_DEPLOY_1_Y -82.0
  #define Z_PROBE_ALLEN_KEY_DEPLOY_1_Z   5.0
  #define Z_PROBE_ALLEN_KEY_DEPLOY_1_FEEDRATE XY_PROBE_SPEED

  #define Z_PROBE_ALLEN_KEY_DEPLOY_2_X  82.0
  #define Z_PROBE_ALLEN_KEY_DEPLOY_2_Y -82.0
  #define Z_PROBE_ALLEN_KEY_DEPLOY_2_Z Z_PROBE_ALLEN_KEY_DEPLOY_1_Z
  #define Z_PROBE_ALLEN_KEY_DEPLOY_2_FEEDRATE (XY_PROBE_SPEED)/10

  #define Z_PROBE_ALLEN_KEY_DEPLOY_3_X Z_PROBE_ALLEN_KEY_DEPLOY_1_X
  #define Z_PROBE_ALLEN_KEY_DEPLOY_3_Y Z_PROBE_ALLEN_KEY_DEPLOY_1_Y
  #define Z_PROBE_ALLEN_KEY_DEPLOY_3_Z Z_PROBE_ALLEN_KEY_DEPLOY_2_Z
  #define Z_PROBE_ALLEN_KEY_DEPLOY_3_FEEDRATE XY_PROBE_SPEED

  #define Z_PROBE_ALLEN_KEY_STOW_1_X  49.0 // Move the probe into position
  #define Z_PROBE_ALLEN_KEY_STOW_1_Y -96.0
  #define Z_PROBE_ALLEN_KEY_STOW_1_Z  15.0
  ...
  #define Z_PROBE_ALLEN_KEY_STOW_3_X Z_PROBE_ALLEN_KEY_STOW_1_X // Move it up to clear
...
#define DEBUG_LEVELING_FEATURE
  ...
  #define AUTO_BED_LEVELING_GRID  // Deltas only support grid mode.
    ...
    #define DELTA_PROBEABLE_RADIUS (DELTA_PRINTABLE_RADIUS - 18)
...
#define MANUAL_Z_HOME_POS 302 // Distance between the nozzle to printbed after homing
